    ...
    export default {
        ...
        methods: {
            ...
            drawText(ctx, txt, i) {
                ...
                let y = this.fontSizeMax /2 //this.randomNum(this.fontSizeMax, this.contentHeight - 5)
        ...
        watch: {
            identifyCode(oldValue, newValue) {
                window.console.log("verifCode_watch", oldValue, "", newValue)
                // this.identifyCode = newValue
                this.drawPic()
            }
        },
        beforeUpdate(){
            window.console.log("verfycode_comp_beforeupdate!")
        },
        mounted() {
            window.console.log("verifucode_comp加载", this.identifyCode)
            this.drawPic()
        }
    }
</script>
